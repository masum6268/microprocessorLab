...
.data
    ...
    newline db 0ah, 0dh, "$" ; Newline character for output
...
output macro value 
     mov ah, 02 ; Function to print a string
     mov dl,value
     add dl,'0'
     int 21h
...
nextDigit:
    ...
    div bx ; Divide sum by the number of digits
    
    ;mov avg value
    mov avg,al

    ; Output show Average msg
    ;mov ah, 09h ; Function to print a string
    ;lea dx, msgAverage
    ;int 21h 
    show msgAverage
    ...
    ;mov dl, maxVal ; Load largest value
    ...
    output minVal
    ;mov ah, 02h ; Function to print a character
    ;mov dl, minVal ; Load smallest value
    ;add dl, '0' ; Convert to ASCII
    ;int 21h
