...
data segment
    ...
    WORD_HUNT 	DB	"ASDFKASJFSKASJDFLKJASKRUEIJDSLFJKLSAJKDSVMNMSDPFKVLSADFDSART"
				...
				DB	"ASAXIEWCPAIEWOIREWOOQIROQWEIROPEWQIRPOWQEOOPREWQORIWQEPOIAEE"
				DB	"ASNFASCJRKASDJFKLASDSEEKDSAJFLKSDAJFASLKCDJFOICSADFDSKSLPDEE"
				DB	"ASKFAIDOISADFISOADILAEDFISAODIFOSADIFSAODPICPVSADIFOPDSAISAA"
				DB	"ASAOSFSADFINVNCXJDFIIEDSNFLSDAFUSADFUSDAIFEISODUFIODSANISDDD"
				DB	"QWJUUSIDWERUIOQWEURZOWEQUIRWEQUIORUQWOEIUANVDMSADFKLSEDALKBB"
				DB	"LSMDEPOOESNVMXNCFDSAKLSEESLAFSHVAFDJNFSYNDSNFSDAYUEQSDSAAMCC"
				DB	"JLSRKLAODKYCASDLIURRWEUIRTRUERIOQEWURIOFDSHFJSADHFJESDADEDAD"
				DB	"VOPMZXEGUOMSZNCVMIEBNOTILISOSDIOFISDAOFIOSADIFODSIFOSDATODVD"
				DB	"QMYERUQIWERUIQWEURIOQWRURIQWUERIUQWEIRUQWIOERUIQWEURIEYUUQAA"
